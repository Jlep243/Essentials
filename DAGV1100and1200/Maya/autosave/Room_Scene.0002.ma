...
//Name: Room_Scene.0002.ma
//Last modified: Tue, Sep 02, 2025 11:22:16 AM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "976ED208-46BC-A23F-B8F9-F3BDB1666462";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.3948795920038579 10.389276983399723 -7.6362026639404395 ;
	setAttr ".r" -type "double3" -64.80000000011924 1363.1999999999898 1.3928366815176656e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 11.025131501917754;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 11.018779385476352 0 -3.6515025591366097 ;
...
createNode transform -n "floorBoard1";
	...
	setAttr ".t" -type "double3" 8.8942577117156567 0 -11.790544153638884 ;
	setAttr ".s" -type "double3" 1 0.15539645427263038 5.0790953609892169 ;
...
createNode transform -n "floorBoard3";
	...
	setAttr ".t" -type "double3" 11.018033557008463 0.041917793434056078 6.2641219498620337 ;
	setAttr ".s" -type "double3" 1 0.15539645427263038 11.366755550264697 ;
