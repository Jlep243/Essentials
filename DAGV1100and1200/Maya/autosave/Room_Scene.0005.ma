...
//Name: Room_Scene.0005.ma
//Last modified: Tue, Sep 02, 2025 11:52:18 AM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "15260F0C-4FC4-A08A-E63C-D380842627CB";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.4493153480613006 10.905973047177534 4.9546926117997483 ;
	setAttr ".r" -type "double3" -66.600000001307947 1717.2000000002095 -2.5376786275442245e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 10.520818642170658;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 8.0216828263704087 0.041928008659952387 -7.15761646326402 ;
...
createNode transform -n "floorBoard15";
	...
	setAttr ".t" -type "double3" 7.0284894950483059 0.041928008659952387 10.86988654439851 ;
	setAttr ".s" -type "double3" 1.0029693989638757 0.15585788834293751 2.7189050884473405 ;
...
createNode transform -n "floorBoard17";
	...
	setAttr ".t" -type "double3" 6.0459255966516565 0.041928008659952387 6.5253544008311399 ;
	setAttr ".s" -type "double3" 1.0029693989638757 0.15585788834293751 10.947656289055208 ;
