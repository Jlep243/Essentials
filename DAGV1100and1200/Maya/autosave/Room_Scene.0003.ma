...
//Name: Room_Scene.0003.ma
//Last modified: Tue, Sep 02, 2025 11:32:16 AM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "B9150832-4E7A-EE45-199A-3D858C48359F";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.9806462011309289 13.483152607511098 7.9027618707409228 ;
	setAttr ".r" -type "double3" -79.199999998712372 1346.0000000000225 1.2722218725854067e-13 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 13.731198146645895;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 9.0210494997297435 0.041928008659952387 11.16990520475081 ;
...
createNode transform -n "floorBoard1";
	...
	setAttr ".t" -type "double3" 11.001765861948723 0.0372014975766643 -12.025454606592435 ;
	setAttr ".s" -type "double3" 1 0.15539645427263038 5.1917632117690387 ;
...
createNode transform -n "floorBoard3";
	...
	setAttr ".t" -type "double3" 11.018033557008463 0.041917793434056078 6.323866256094691 ;
	setAttr ".r" -type "double3" 0.34706397274459194 0.013043196436845548 -1.2658051201938376 ;
	setAttr ".s" -type "double3" 1 0.15539645427263038 11.469001704703262 ;
...
createNode transform -n "floorBoard5";
	...
	setAttr ".t" -type "double3" 10.014456801642101 0.041928008659952387 3.8607422636124902 ;
...
createNode transform -n "floorBoard6";
	...
	setAttr ".t" -type "double3" 10.015877506526797 0.0372014975766643 9.3197179524911622 ;
	setAttr ".s" -type "double3" 1 0.15539645427263038 5.1917632117690387 ;
	setAttr ".rp" -type "double3" -5.9604644775390625e-08 0 1.5162737914873143 ;
	setAttr ".sp" -type "double3" -5.9604644775390625e-08 0 0.26093775033950806 ;
	setAttr ".spt" -type "double3" 0 0 1.2553360411478063 ;
...
createNode transform -n "floorBoard7";
	...
	setAttr ".t" -type "double3" 9.0210494997297435 0.041928008659952387 -1.2039106065214806 ;
	setAttr ".s" -type "double3" 1 0.15539645427263038 13.260953244249185 ;
...
createNode transform -n "floorBoard9";
	...
	setAttr ".t" -type "double3" 9.0210494997297435 0.041928008659952387 8.2798677851462621 ;
	setAttr ".s" -type "double3" 1 0.15539645427263038 7.8850098949358465 ;
