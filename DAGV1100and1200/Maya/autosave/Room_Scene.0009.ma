...
//Name: Room_Scene.0009.ma
//Last modified: Tue, Sep 02, 2025 12:32:20 PM
//Codeset: 1252
requires maya "2026";
...
fileInfo "UUID" "40B7F755-45C9-E2AB-9AF8-1E8219A5D018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.2534099083119794 32.147806116149489 -4.6949024813048803 ;
	setAttr ".r" -type "double3" -90.000000000015959 -88.399999999983919 -2.2782005833682049e-13 ;
	setAttr ".rpt" -type "double3" -1.3489310268038035e-15 1.7731241355463492e-15 -1.9462930953802607e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "22F18411-4564-03D4-A243-218DB74115B6";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 30.122796086496052;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 8.030583063226107 0.041928008659952387 7.7016856050543616 ;
...
createNode transform -n "floorBoard4";
	...
	setAttr ".t" -type "double3" -3.47206415026176 0.041928008659952387 -6.9211592032690872 ;
	setAttr ".s" -type "double3" 1 0.15539645427263038 13.260953244249185 ;
...
createNode transform -n "floorBoard6";
	...
	setAttr ".t" -type "double3" -4.8148262654267686 0.0372014975766643 14.297299701500458 ;
...
createNode transform -n "floorBoard7";
	...
	setAttr ".t" -type "double3" -7.1372943714214667 0.041928008659952387 -1.1847227267418892 ;
...
createNode transform -n "floorBoard8";
	...
	setAttr ".t" -type "double3" -1.2659086529160906 0.0372014975766643 -6.5743389056633488 ;
...
createNode transform -n "floorBoard9";
	...
	setAttr ".t" -type "double3" -3.8252796842804493 0.041928008659952387 8.3257295628542973 ;
...
createNode transform -n "floorBoard12";
	...
	setAttr ".t" -type "double3" -1.310998106677113 0.041928008659952387 6.6876783704890599 ;
...
createNode transform -n "floorBoard18";
	...
	setAttr ".t" -type "double3" -5.2148553570016727 0.041928008659952387 -10.563478285442466 ;
...
createNode transform -n "floorBoard22";
	...
	setAttr ".t" -type "double3" -5.280495361380642 0.041928008659952387 -4.2010198633503224 ;
	setAttr ".s" -type "double3" 1.0029693989638757 0.15585788834293751 13.493889621296891 ;
...
createNode transform -n "floorBoard30";
	...
	setAttr ".t" -type "double3" -11.373821389295669 0.041928008659952387 7.4313216741734323 ;
...
createNode transform -n "floorBoard52";
	...
	setAttr ".t" -type "double3" 1.0717226709066532 0.061972606897629345 -7.7950742364822379 ;
...
createNode transform -n "floorBoard54";
	...
	setAttr ".t" -type "double3" 0.076140070081458455 0.061972606897629345 -8.9814978262169216 ;
